...
lesson <- lesson_from_data(
  ...
  title = "R-LearnXR reference data space", id = "lesson"
)
compile_lesson(
  lesson,
...
write_reference_data_license(
  ...
  "Synthetic contributor-training points bundled with R-LearnXR.",
...
write_lesson_manifest(
  ...
  dataset_source = "Synthetic contributor-training points bundled with R-LearnXR.",
  dataset_license = "CC0",
  overwrite = TRUE
)
