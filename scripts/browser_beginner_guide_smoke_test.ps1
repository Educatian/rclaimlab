...
$session = "rclaimlab-beginner-guide"
$server = $null
...
try {
  ...
  Invoke-PwCli screenshot --filename="output/playwright/rclaimlab-beginner-guide-top.png" | Out-Null
  Invoke-PwCli screenshot --filename="output/playwright/rclaimlab-beginner-guide-desktop.png" --full-page | Out-Null
  ...
  Invoke-PwCli screenshot --filename="output/playwright/rclaimlab-beginner-guide-mobile.png" --full-page | Out-Null
  Write-Output "R-ClaimLab beginner-guide browser smoke test passed."
} finally {
