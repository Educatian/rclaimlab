...
$session = "rlearnxr-offline-smoke"
$server = $null
...
try {
  ...
  Invoke-PwCli screenshot --filename="output/playwright/rlearnxr-browser-offline-fallback.png" | Out-Null
  ...
  Write-Output "R-LearnXR offline browser smoke test passed: static fallback loaded and first-run network failure was surfaced."
} finally {
