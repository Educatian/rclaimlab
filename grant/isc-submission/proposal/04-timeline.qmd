...
The rows identify project work-package totals, outcomes, and partial-funding priorities; they do not request four separate payments or presume individual payment allocations, and contract terms govern disbursement. Funds support direct labor during the grant period. No indirect costs, travel, lodging, food, publication fees, or personal hardware are requested. Existing prototype code, UI refinement, narration, screenshots, and the ten current lessons are in-kind feasibility evidence and are not charged retroactively.

The Project Lead owns deliverable packages 1-3. Yeonji Jung, the proposed Co-Lead for Community Validation and Adoption, will own package 4 after written consent, January-June 2027 availability, and milestone acceptance are confirmed. Before submission, two R/Quarto reviewers and at least one short usability participant will be recruited for in-kind validation; their findings will be dispositioned as proposal revisions, release issues, or documented out-of-scope items.
